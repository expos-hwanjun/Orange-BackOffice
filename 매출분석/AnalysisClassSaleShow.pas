...
type
  TAnalysisClassSaleShowForm = class(TInheritShowForm)
...
var
  AnalysisClassSaleShowForm: TAnalysisClassSaleShowForm;

implementation
uses Common, DBModule;
{$R *.dfm}

procedure TAnalysisClassSaleShowForm.Exec_TimerTimer(Sender: TObject);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.FormActivate(Sender: TObject);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.FormCreate(Sender: TObject);
begin
  inherited;
  ...
  GridLevel1.Visible  := GetOption(248) >= '1';
  GridLevel2.Visible  := GetOption(248) >= '2';
  GridLevel3.Visible  := GetOption(248) >= '3';
  if not GridLevel1.Visible then
    GridLevel.Caption := ' 분 류 ';
  LastActiveLevel := 0;
end;

procedure TAnalysisClassSaleShowForm.FormDestroy(Sender: TObject);
begin
  inherited;
  FusionChart.Free;
end;

procedure TAnalysisClassSaleShowForm.GridTableView1CellClick(
...
procedure TAnalysisClassSaleShowForm.GridTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableView2CellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableView2CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableView3CellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableView3CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableViewCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.GridTableViewCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  inherited;
...
procedure TAnalysisClassSaleShowForm.ChartPanelResize(Sender: TObject);
begin
  inherited;
...
function TAnalysisClassSaleShowForm.DoSearch: Boolean;
var  vIndex     : Integer;
     vChartXml  : String;
     vCondition :String;
begin
  ...
  begin
    ...
    OpenQuery('select   Ifnull(a.CD_CLASS,'''') as CD_CLASS, '
             ...
             +'                  MS_MENU_CLASS as c on g.CD_HEAD  = c.CD_HEAD '
             +'                                    and g.CD_STORE = c.CD_STORE '
             +'                                    and g.CD_CLASS = c.CD_CLASS '
             +'                                    and c.CD_CLASS <> '''' '
             +'                                    and Left(c.CD_CLASS,6) = :P4  '
             +'          where   d.CD_HEAD  =:P0 '
             +'            and   d.CD_STORE =:P1 '
             +'            and   d.YMD_SALE between :P2 and :P3 '
             +'         group by SubString(Ifnull(g.CD_CLASS,''''),6,2)) as a '
             +' order by a.CD_CLASS',
             [HeadStoreCode,
              StoreCode,
              DtoS(ConditionToolBarFromDateEdit.Date),
...
procedure TAnalysisClassSaleShowForm.ButtonToolBarPrintButtonPopupMenuReceiptClick(
  Sender: TObject);
