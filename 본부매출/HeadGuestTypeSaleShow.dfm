inherited HeadGuestTypeSaleShowForm: THeadGuestTypeSaleShowForm
  Left = 300
  Top = 120
  Caption = #44256#44061#50976#54805#48324' '#47588#52636'('#48376#48512')'
  ClientHeight = 612
  ClientWidth = 964
    ...
    object GridBandedTableView: TcxGridBandedTableView [1]
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewNoneCnt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewNoneAmt
        end
        item
          Column = GridBandedTableViewNoneRate
        end>
      ...
      object GridBandedTableViewNoneCnt: TcxGridBandedColumn
        Caption = #44256#44061#49688
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'CNT_NONE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewNoneAmt: TcxGridBandedColumn
        Caption = #44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_NONE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewNoneRate: TcxGridBandedColumn
        Caption = #51216#50976#50984
        DataBinding.FieldName = 'RT_NONE'
        PropertiesClassName = 'TcxProgressBarProperties'
    ...
    object GridBandedTableView1: TcxGridBandedTableView [2]
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableView1NoneCnt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableView1NoneAmt
        end
        item
          Column = GridBandedTableView1NoneRate
        end>
      DataController.Summary.SummaryGroups = <>
      OptionsSelection.CellSelect = False
      OptionsView.Footer = True
      ...
      object GridBandedTableView1NoneCnt: TcxGridBandedColumn
        Caption = #44256#44061#49688
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'CNT_NONE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
      ...
      object GridBandedTableView1NoneAmt: TcxGridBandedColumn
        Caption = #44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_NONE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
      ...
      object GridBandedTableView1NoneRate: TcxGridBandedColumn
        Caption = #51216#50976#50984
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'RT_NONE'
        PropertiesClassName = 'TcxProgressBarProperties'
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      ...
      PrinterPage.PageHeader.CenterTitle.Strings = (
        #44061#52789#48324' '#47588#52636' '#51312#54924
        '')
      ReportDocument.CreationDate = 41417.704738483800000000
