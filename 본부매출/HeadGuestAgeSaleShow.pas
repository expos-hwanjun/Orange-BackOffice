...
type
  THeadGuestAgeSaleShowForm = class(TInheritShowForm)
...
var
  HeadGuestAgeSaleShowForm: THeadGuestAgeSaleShowForm;
...
//------------------------------------------------------------------------------
// 폼을 만들 때
procedure THeadGuestAgeSaleShowForm.FormCreate(Sender: TObject);
var
  vColumn: TcxGridBandedColumn;
begin
  inherited;
  HelpURL := 'BackOffice/매출분석/연령대별매출조회/연령대별매출조회.htm';
...
//------------------------------------------------------------------------------
// 폼을 보여줄 때
procedure THeadGuestAgeSaleShowForm.FormShow(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 폼을 없앨 때
procedure THeadGuestAgeSaleShowForm.FormDestroy(Sender: TObject);
begin
  GuestTypeList.Free;
...
//------------------------------------------------------------------------------
// 날짜에서 키보드를 누를 때
procedure THeadGuestAgeSaleShowForm.ConditionToolBarToDateEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 조회
function THeadGuestAgeSaleShowForm.DoSearch:Boolean;
var
  vRow,
  vCol,
  vIndex: Integer;
