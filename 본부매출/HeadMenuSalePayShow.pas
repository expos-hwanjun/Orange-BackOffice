...
type
  THeadMenuSalePayShowForm = class(TInheritShowForm)
...
var
  HeadMenuSalePayShowForm: THeadMenuSalePayShowForm;
...
procedure THeadMenuSalePayShowForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure THeadMenuSalePayShowForm.GridTableView1CellDblClick(
...
function THeadMenuSalePayShowForm.DoSearch: Boolean;
begin
  ...
  begin
    if GetChainHeadOption(2) = '1' then
      ...
      OpenQuery('select left(m.CD_CLASS,2) as CD_CLASS, '
               ...
               +'                   and a.DS_SALE <> ''V'' '
               +'                 group by a.YMD_SALE, a.NO_POS, a.NO_RCP, b.CD_MENU_HEAD) a inner join '
               +'               (select YMD_SALE, '
               +'                       NO_POS, '
               +'                       NO_RCP, '
               +'                       AMT_SALE, '
