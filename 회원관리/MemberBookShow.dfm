inherited MemberBookShowForm: TMemberBookShowForm
  Left = 300
  Top = 120
  Caption = #54924#50896' '#50808#49345#48120#49688#44552' '#51092#50529' '#51312#54924
  ClientHeight = 612
  ClientWidth = 964
  HelpFile = #54980#48169'/'#44144#47000#52376#44288#47532'/'#44144#47000#52376#50896#51109'.htm'
  OnDestroy = FormDestroy
  ExplicitWidth = 980
  ExplicitHeight = 651
  PixelsPerInch = 96
  TextHeight = 17
  object Splitter: TAdvSplitter [0]
    Left = 0
    Top = 406
    Width = 964
    Height = 6
  ...
  inherited ToolBarDockPanel: TAdvDockPanel
    ...
    inherited ConditionToolBar: TAdvToolBar
      ...
      object ConditionMemberCodeEdit: TcxButtonEdit
        Left = 465
        Top = 2
        ParentFont = False
        ...
        Properties.OnButtonClick = ConditionMemberCodeEditPropertiesButtonClick
        Properties.OnChange = ConditionMemberCodeEditPropertiesChange
        Properties.OnValidate = ConditionMemberCodeEditPropertiesValidate
        Style.StyleController = EditStyleController
        TabOrder = 10
        Width = 99
      end
      object ConditionMemberNameLabel: TcxLabel
        Left = 564
        Top = 2
        AutoSize = False
        ParentColor = False
      ...
      object ConditionCheckBox: TcxCheckBox
        Left = 771
        Top = 2
        Caption = ' '#51092#50529#26377
        ParentFont = False
        Style.StyleController = EditStyleController
        TabOrder = 12
      end
  ...
  inherited Grid: TcxGrid
    ...
    inherited GridTableView: TcxGridTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Format = ',0'#44148
          Kind = skCount
          Column = GridTableViewMemberCode
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridTableViewBeforeAmt
        end
        item
          Format = ',0'
          Kind = skSum
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = GridTableViewCreditAmt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridTableViewPayAmt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridTableViewRemainAmt
        end>
      ...
      object GridTableViewMemberType: TcxGridColumn
      ...
      object GridTableViewBeforeAmt: TcxGridColumn
      ...
      object GridTableViewCreditAmt: TcxGridColumn
      ...
      object GridTableViewPayAmt: TcxGridColumn
      ...
      object GridTableViewRemainAmt: TcxGridColumn
        Caption = #48120#49688#51092#50529'(A+B-C)'
        DataBinding.ValueType = 'Currency'
    ...
    object BookGridTableView: TcxGridTableView [1]
      ...
      OnCellDblClick = BookGridTableViewCellDblClick
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Format = ',0'#44148
          Kind = skCount
          Column = BookGridTableViewDate
        end
        item
          Format = ',0'
          Kind = skSum
          Column = BookGridTableViewSaleAmt
        end
        item
          Format = ',0'
          Kind = skSum
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = BookGridTableViewCreditAmt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = BookGridTableViewPayAmt
        end
        item
          Format = ',0'
      ...
      object BookGridTableViewDate: TcxGridColumn
      ...
      object BookGridTableViewType: TcxGridColumn
        Caption = #44396#48516
      ...
      object BookGridTableViewSaleAmt: TcxGridColumn
        Caption = #54032#47588#44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_SALE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
      ...
      object BookGridTableViewCreditAmt: TcxGridColumn
      ...
      object BookGridTableViewDCAmt: TcxGridColumn
      ...
      object BookGridTableViewPayAmt: TcxGridColumn
      ...
      object BookGridTableViewRemainAmt: TcxGridColumn
        Caption = #48120#49688#51092#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_REMAIN'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
      ...
      object BookGridTableViewRemark: TcxGridColumn
        Caption = #48708#44256
    ...
    object GoodsGridTableView: TcxGridTableView [2]
      Tag = 99
      Navigator.Buttons.CustomButtons = <>
      ScrollbarAnnotations.CustomAnnotations = <>
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Format = ',0'#44148
          Kind = skCount
          Column = GoodsGridTableViewColumn1
        end
        item
          Format = ',0'
          Kind = skSum
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = GoodsGridTableViewColumn6
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GoodsGridTableViewColumn7
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GoodsGridTableViewColumn8
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GoodsGridTableViewColumn9
        end>
      DataController.Summary.SummaryGroups = <>
      OptionsSelection.CellSelect = False
      OptionsView.Footer = True
      OptionsView.GroupByBox = False
      Styles.ContentEven = StyleEven
      object GoodsGridTableViewColumn1: TcxGridColumn
      ...
      object GoodsGridTableViewColumn2: TcxGridColumn
      ...
      object GoodsGridTableViewColumn4: TcxGridColumn
        Caption = #49688#47049
        DataBinding.ValueType = 'Currency'
      ...
      object GoodsGridTableViewColumn6: TcxGridColumn
      ...
      object GoodsGridTableViewColumn7: TcxGridColumn
      ...
      object GoodsGridTableViewColumn8: TcxGridColumn
        Caption = #54032#47588#44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_SALE'
        PropertiesClassName = 'TcxCurrencyEditProperties'
      ...
      object GoodsGridTableViewColumn9: TcxGridColumn
        Caption = #54624#51064#44552#50529
        DataBinding.ValueType = 'Currency'
    ...
    inherited GridLevel: TcxGridLevel
      Caption = #44144#47000#52376#48324' '#48120#51648#44553#45236#50669
    end
    object BookGridLevel: TcxGridLevel
  ...
  object ConditionTabSet: TAdvOfficeTabSet [4]
    Left = 0
    Top = 65
    Width = 964
    Height = 27
    AdvOfficeTabs = <
      item
        Caption = ' '#54924#50896' '#48120#49688' '#45236#50669
    ...
    object CommentLabel: TLabel
      ...
      Caption = #51312#54924#44592#44036#44620#51648#51032' '#51092#50529#47564' '#54364#49884#46104#48064#47196' '#52509' '#48120#51648#44553#51092#50529#44284' '#45796#47484' '#49688' '#51080#49845#45768#45796'.'
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    ...
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      PrinterPage.PageHeader.CenterTitle.Strings = (
        #54924#50896' '#48120#49688#44552' '#51092#50529' '#51312#54924
        '')
      ReportDocument.CreationDate = 40947.404648587970000000
      PixelsPerInch = 96
