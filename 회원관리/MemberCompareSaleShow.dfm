inherited MemberCompareSaleShowForm: TMemberCompareSaleShowForm
  Left = 300
  Top = 120
  Caption = #54924#50896':'#51068#48152' '#47588#52636' '#48708#44368' '#51312#54924
  ClientHeight = 602
  ClientWidth = 964
  ExplicitWidth = 980
  ExplicitHeight = 641
    ...
    object GridBandedTableView: TcxGridBandedTableView [1]
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewMemberQty
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewMemberAmt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewMemberPrice
        end
        item
          Format = '0 %'
          Kind = skAverage
          Column = GridBandedTableViewMemberRate
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewNormalQty
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewNormalAmt
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewNormalPrice
        end
        item
          Format = '0 %'
          Kind = skAverage
          Column = GridBandedTableViewNormalRate
        end
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewTotalQty
        end
        item
          Format = ',0'
          Kind = skSum
        ...
        item
          Format = ',0'
          Kind = skSum
          Column = GridBandedTableViewTotalPrice
        end
        item
          Format = ',0'
          Kind = skSum
      ...
      object GridBandedTableViewMemberQty: TcxGridBandedColumn
        Caption = #44061#49688
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'CNT_MEMBER'
      ...
      object GridBandedTableViewMemberAmt: TcxGridBandedColumn
        Caption = #54032#47588#44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_MEMBER'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewMemberPrice: TcxGridBandedColumn
        Caption = #44061#45800#44032
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'PR_MEMBER'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewMemberRate: TcxGridBandedColumn
        Caption = #51216#50976#50984
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'RT_MEMBER'
      ...
      object GridBandedTableViewNormalQty: TcxGridBandedColumn
        Caption = #44061#49688
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'CNT_NORMAL'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewNormalAmt: TcxGridBandedColumn
        Caption = #54032#47588#44552#50529
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'AMT_NORMAL'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewNormalPrice: TcxGridBandedColumn
        Caption = #44061#45800#44032
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'PR_NORMAL'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
      ...
      object GridBandedTableViewNormalRate: TcxGridBandedColumn
        Caption = #51216#50976#50984
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'RT_NORMAL'
        PropertiesClassName = 'TcxProgressBarProperties'
        Properties.BarStyle = cxbsGradient
        Properties.BeginColor = clSkyBlue
        Properties.EndColor = clBlue
      ...
      object GridBandedTableViewTotalQty: TcxGridBandedColumn
        Caption = #44061#49688
        DataBinding.ValueType = 'Currency'
      ...
      object GridBandedTableViewTotalPrice: TcxGridBandedColumn
        Caption = #44061#45800#44032
        DataBinding.ValueType = 'Currency'
        DataBinding.FieldName = 'PR_TOTAL'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taRightJustify
        Properties.DisplayFormat = ',0'
        FooterAlignmentHorz = taRightJustify
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    ...
    inherited dxComponentPrinter1Link1: TdxGridReportLink
      PrinterPage.PageHeader.CenterTitle.Strings = (
        #54924#50896' '#51068#48152' '#47588#52636' '#48708#44368)
      ReportDocument.CreationDate = 40423.445678159720000000
      PixelsPerInch = 96
