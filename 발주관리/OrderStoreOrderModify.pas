...
type
  TOrderStoreOrderModifyForm = class(TInheritShow2Form)
    ListGrid: TcxGrid;
...
var
  OrderStoreOrderModifyForm: TOrderStoreOrderModifyForm;
...
//------------------------------------------------------------------------------
// 폼을 만들 때
procedure TOrderStoreOrderModifyForm.FormActivate(Sender: TObject);
...
procedure TOrderStoreOrderModifyForm.FormCreate(Sender: TObject);
begin
  inherited;
  PrintMode   := pmExcel;
  DefaultDate := ddToday;
...
//------------------------------------------------------------------------------
// 폼에서 키보드를 누를 때
procedure TOrderStoreOrderModifyForm.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 날짜에서 키보드를 누를 때
procedure TOrderStoreOrderModifyForm.ConditionToolBarToDateEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 삭제 버튼
procedure TOrderStoreOrderModifyForm.ButtonToolBarCancelButtonClick(Sender: TObject);
begin
  inherited;
...
procedure TOrderStoreOrderModifyForm.ButtonToolBarDeleteButtonClick(Sender: TObject);
var
...
procedure TOrderStoreOrderModifyForm.ButtonToolBarPrintButtonPopupMenuPrintClick(
  Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 수정 버튼
procedure TOrderStoreOrderModifyForm.ButtonToolBarSaveButtonClick(Sender: TObject);
var vTemp :String;
begin
...
procedure TOrderStoreOrderModifyForm.ListGridTableViewFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
var
  vDate: string;
begin
  inherited;
...
procedure TOrderStoreOrderModifyForm.GridDBTableViewFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
...
procedure TOrderStoreOrderModifyForm.GridDBTableViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
...
//------------------------------------------------------------------------------
// 조회
function TOrderStoreOrderModifyForm.DoSearch:Boolean;
begin
//  inherited;
