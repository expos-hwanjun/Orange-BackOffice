...
type
  THeadSaleZoneByOrderShowForm = class(TInheritShowForm)
...
var
  HeadSaleZoneByOrderShowForm: THeadSaleZoneByOrderShowForm;
...
function THeadSaleZoneByOrderShowForm.DoSearch: Boolean;
begin
  OpenQuery('select c.NM_CODE1 as SALEZONE, '
           ...
           +'       MS_CODE   c on c.CD_HEAD = b.CD_HEAD and c.CD_KIND = ''03'' and c.CD_CODE = b.CD_LOCAL '
           +' where a.CD_HEAD = :P0 '
...
procedure THeadSaleZoneByOrderShowForm.FormCreate(Sender: TObject);
begin
  inherited;
