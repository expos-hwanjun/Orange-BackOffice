...
type
  THeadMenuClassForm = class(TInheritEditForm)
    Class1Panel: TPanel;
...
var
  HeadMenuClassForm: THeadMenuClassForm;
...
//------------------------------------------------------------------------------
// 폼을 보여줄 때
procedure THeadMenuClassForm.FormShow(Sender: TObject);
var vIndex :Integer;
begin
  inherited;
  DestStoreCode := '';
  ...
  Class2Panel.Visible    := GetHeadOption(248) >= '1';
  Class2Splitter.Visible := Class2Panel.Visible;
  Class3Panel.Visible    := GetHeadOption(248) >= '2';
  Class3Splitter.Visible := Class3Panel.Visible;
  Class4Panel.Visible    := GetHeadOption(248) >= '3';
...
//------------------------------------------------------------------------------
// 폼 크기를 변경할 때
procedure THeadMenuClassForm.FormResize(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 폼에서 키보드를 누를 때
procedure THeadMenuClassForm.FormCreate(Sender: TObject);
begin
  inherited;
  HelpURL := 'BackOffice/코드관리/6.분류관리/분류관리.htm';
end;

procedure THeadMenuClassForm.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드에 포커스가 들어갈 때
procedure THeadMenuClassForm.ClassGridEnter(Sender: TObject);
var
  vIndex: Integer;
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드에서 포커스가 나갈 때
procedure THeadMenuClassForm.ClassGridExit(Sender: TObject);
var
  vIndex: Integer;
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드1 선택 레코드를 옮길 때
procedure THeadMenuClassForm.Class1GridTableViewFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드2 선택 레코드를 옮길 때
procedure THeadMenuClassForm.Class2GridTableViewFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드3 선택 레코드를 옮길 때
procedure THeadMenuClassForm.Class3GridTableViewFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드1 제목줄을 선택할 때
procedure THeadMenuClassForm.Class1LabelClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드2 제목줄을 선택할 때
procedure THeadMenuClassForm.Class2LabelClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드3 제목줄을 선택할 때
procedure THeadMenuClassForm.Class3LabelClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드4 제목줄을 선택할 때
procedure THeadMenuClassForm.Class4LabelClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드1 상품분류이름을 검증할 때
procedure THeadMenuClassForm.Class1GridTableViewClassNamePropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드2 상품분류이름을 검증할 때
procedure THeadMenuClassForm.Class2GridTableViewClassNamePropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드3 상품분류이름을 검증할 때
procedure THeadMenuClassForm.Class3GridTableViewClassNamePropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 그리드4 상품분류이름을 검증할 때
procedure THeadMenuClassForm.Class4GridTableViewClassNamePropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 팝업메뉴가 뜰 때
procedure THeadMenuClassForm.ClassPopupPopup(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 상품분류 복사 팝업메뉴
procedure THeadMenuClassForm.ClassPopupCopyClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 상품분류 붙여넣기 팝업메뉴
procedure THeadMenuClassForm.ClassPopupPasteClick(Sender: TObject);
var
  vClassCode: string;
begin
  inherited;
...
//------------------------------------------------------------------------------
// 상품분류코드 변경 팝업메뉴
procedure THeadMenuClassForm.ClassPopupChangeCodeClick(Sender: TObject);
var
...
//------------------------------------------------------------------------------
// 신규
procedure THeadMenuClassForm.ButtonToolBarNewButtonClick(Sender: TObject);
begin
  inherited;
...
//------------------------------------------------------------------------------
// 삭제
function THeadMenuClassForm.DoDelete: Boolean;
var
  vClassCode: string;
begin
  try
...
//------------------------------------------------------------------------------
// 자료 즉시 저장
procedure THeadMenuClassForm.SaveData(aClassCode, aClassName, aOldClassCode: string);
var
  vClassCode: string;
  vClassName: string;
  vIndex    : Integer;
...
begin
  ...
  try
    ...
    begin
      if Copy(CopyPos(WorkStoreList.Strings[vIndex], splitColumn, 2),1,1) = '0' then Continue;
      vSQL := vSQL + Format('(''%s'',''%s'',''%s'',''%s'',0,Now()),',
                           [HeadStoreCode,
                            CopyPos(WorkStoreList.Strings[vIndex], splitColumn, 0),
                            vClassCode,
                            vClassName]);
    end;
    ExecQuery('insert into MS_MENU_CLASS(CD_HEAD, CD_STORE, CD_CLASS, NM_CLASS, DS_STATUS,DT_CHANGE ) '
             +' values '+LeftStr(vSQL,Length(vSQL)-1)+';',[],false);
