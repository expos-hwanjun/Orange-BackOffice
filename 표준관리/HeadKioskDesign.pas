...
procedure THeadKioskDesignForm.ColorPopupMenuPopup(Sender: TObject);
begin
  inherited;
...
procedure THeadKioskDesignForm.DeleteColorItemClick(Sender: TObject);
begin
  inherited;
...
procedure THeadKioskDesignForm.KioskFontNameComboBoxPropertiesFontPreviewButtonClick(
  Sender: TObject; ButtonType: TcxFontButtonType);
begin
  inherited;
...
procedure THeadKioskDesignForm.KioskPopupPopup(Sender: TObject);
var vTemp :String;
begin
  inherited;
...
procedure THeadKioskDesignForm.MoveSizeCheckBoxPropertiesChange(Sender: TObject);
begin
  inherited;
  SetMoveSize;
end;

procedure THeadKioskDesignForm.RatingBluePanelClick(Sender: TObject);
begin
  inherited;
...
procedure THeadKioskDesignForm.SetMoveSize;
var vIndex :Integer;
begin
...
procedure THeadKioskDesignForm.SizeCopyMenuItemClick(Sender: TObject);
begin
  inherited;
...
procedure THeadKioskDesignForm.SizePasteLeftMenuItemClick(Sender: TObject);
begin
  inherited;
...
procedure THeadKioskDesignForm.SizePasteTopMenuItemClick(Sender: TObject);
begin
  inherited;
