...
type
  THeadMemberSMSSaleShowForm = class(TInheritShowForm)
...
var
  HeadMemberSMSSaleShowForm: THeadMemberSMSSaleShowForm;
...
procedure THeadMemberSMSSaleShowForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure THeadMemberSMSSaleShowForm.FormDestroy(Sender: TObject);
begin
  inherited;
  FusionChart.Free;
end;

procedure THeadMemberSMSSaleShowForm.ButtonToolBarDeleteButtonClick(
  Sender: TObject);
var vIndex :Integer;
    vCode :String;
begin
...
procedure THeadMemberSMSSaleShowForm.ChartPanelResize(Sender: TObject);
begin
  inherited;
...
function THeadMemberSMSSaleShowForm.DoSearch: Boolean;
var
 vChartXml,
 vChart01,
 vChart02,
...
begin
  OpenQuery('select StoD(a.YMD_SEND) as YMD_SEND, '
           ...
           +'       MS_MEMBER b on a.CD_HEAD    = b.CD_HEAD '
           +'                  and a.CD_STORE   = b.CD_STORE '
           +'                  and a.TEL_MOBILE = GetPhoneNo(AES_Decrypt(b.TEL_MOBILE, 71483)) left outer join '
           +'       (select CD_MEMBER, '
