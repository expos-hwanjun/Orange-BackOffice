...
type
  THeadMemberSMSShowForm = class(TInheritShowForm)
...
var
  HeadMemberSMSShowForm: THeadMemberSMSShowForm;
...
{ TMemberSMSShowForm }
procedure THeadMemberSMSShowForm.FormShow(Sender: TObject);
var  vField :TField;
     vIndex :Integer;
begin
  inherited;
...
procedure THeadMemberSMSShowForm.ButtonToolBarDeleteButtonClick(Sender: TObject);
begin
...
procedure THeadMemberSMSShowForm.ButtonToolBarNotReceiveButtonClick(
  Sender: TObject);
var vIndex :Integer;
begin
  inherited;
...
function THeadMemberSMSShowForm.DoSearch: Boolean;
var
...
procedure THeadMemberSMSShowForm.GridActiveTabChanged(Sender: TcxCustomGrid;
  ALevel: TcxGridLevel);
begin
  inherited;
...
procedure THeadMemberSMSShowForm.GridDBTableView1CellDblClick(
...
procedure THeadMemberSMSShowForm.GridDBTableView1MessagePropertiesPopup(
  Sender: TObject);
begin
  inherited;
...
procedure THeadMemberSMSShowForm.GridDBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
  inherited;
...
procedure THeadMemberSMSShowForm.FormCreate(Sender: TObject);
begin
  inherited;
